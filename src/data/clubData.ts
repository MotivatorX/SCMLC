...
export const DISCIPLINES: Discipline[] = [
  ...
  {
    id: 'civilian-service-rifle',
    number: '05',
    title: 'Civilian Service Rifle',
    schedule: 'SECOND SATURDAY · MONTHLY',
    tagline: 'Precision military service rifle marksmanship with historic bolt-action longarms.',
    description:
      'Civilian Service Rifle (CSR) celebrates the heritage, handling, and authentic marksmanship of classic service rifles. Shooters compete across authentic military courses of fire including deliberate prone application, rapid fire with reload, and positional snap shooting. Held on the second Saturday of each month at the Sackville Range.',
    firearms: [
      'Lee-Enfield Rifles (.303 British No. 1 Mk III*, No. 4 Mk I/II, No. 5 Jungle Carbine)',
      'Pattern 1914 (P14) & M1917 Enfield (.303 & .30-06)',
      'Mauser 98 Actions (Gewehr 98, Kar98k, Swedish M96 6.5×55mm)',
      'Mosin-Nagant M91/30 & M38/M44 (7.62×54mmR)',
      'Springfield M1903 & M1903A3 (.30-06)',
      'Swiss Schmidt-Rubin K11 & K31 (7.5×55mm)',
      'Australian Cadet & Martini-Enfield Rifles (.310 Cadet, .303 British)',
    ],
    courseOfFire:
      'Multi-stage service rifle course at 100m and 200m mounds. Stage 1: Prone Application (10 rounds deliberate). Stage 2: Rapid Fire (10 rounds in 60s with mandatory magazine reload). Stage 3: Positional Snap Shooting (5 rounds standing/kneeling).',
    calibers: 'Classic historic military service calibers (.303 British, 6.5×55mm, 7.62×54mmR, 7.92×57mm Mauser, .30-06 Springfield, 7.5×55mm Swiss, .310 Cadet).',
    powderSpecs: 'Period-correct military loads or factory ammunition strictly adhering to Sackville Range template safety limits.',
    equipmentNotes: 'Eye and ear protection mandatory. Military pattern web or leather sling permitted. Spotting scopes, shooting mats, and chamber safety flags required.',
  },
];
...
export const UPCOMING_EVENTS: ClubEvent[] = [
  // 2026 Season
  {
    id: 'evt-shotgun-2026-jul-12',
    day: '12',
    month: 'JUL',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'Range Working Bee (No Shooting in July)',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'tan',
    description:
      'There is no shooting in July. We will hold our Working Bee from 9:00 AM. Range maintenance, trap testing, brush clearing, and range improvements.',
    matchDirector: 'Range Committee & Captains',
    rangesOpen: '8:30 AM Gates Open',
    fees: 'Free (Volunteers appreciated, morning tea provided)',
    safetyBriefing: 'General maintenance safety briefing at 9:00 AM sharp.',
  ...
  {
    id: 'evt-shotgun-2026-aug-09',
    day: '09',
    month: 'AUG',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Rintoul Trophy',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Official S.C.M.L.C. Shotgun match day featuring 4 Aggregate stages: Hero of the Hill (50 Sporting Targets), Modern 25 (25 from Behind), B P Cartridge Rintoul Trophy (25 Sporting Targets), and Percussion Shotgun Dale Trophy (20 Trap).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Safety Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Mandatory briefing at 8:45 AM. Eye and ear protection strictly required. Card wads only.',
    visitorFriendly: true,
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 from Behind', type: 'Aggregate' },
      { name: 'B P Cartridge - Rintoul Trophy', targets: '25 Sporting Targets', type: 'Aggregate' },
      { name: 'Percussion Shotgun - Dale Trophy', targets: '20 Trap', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-shotgun-2026-aug-15',
    day: '15',
    month: 'AUG',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'Colonial 50 (Muzzle Loading Shotguns)',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Colonial 50 championship for muzzle loading shotguns. 50 Sporting Targets (Aggregate). Trophies awarded through to 5th place. Club lunch included.',
    matchDirector: 'Chief Shotgun Marshal',
    rangesOpen: '8:00 AM Sign-in, 8:45 AM Briefing',
    fees: '$25 entry fee (includes targets & hot lunch)',
    safetyBriefing: 'Strictly traditional muzzle loading shotguns. Wads and powder measures checked.',
    visitorFriendly: true,
    trophies: 'Trophies to 5th place',
    lunchIncluded: true,
    program: [
      { name: 'Colonial 50', targets: '50 Sporting Targets', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-aug-03',
  ...
  {
    id: 'evt-shotgun-2026-aug-16',
    day: '16',
    month: 'AUG',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'S.C.M.L.C. 100 Bird - Ron Millson Trophy',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Premier 100-Bird Open Shotgun Championship for the Ron Millson Trophy. 100 Sporting Targets (Non Aggregate). Open event. Trophies to 5th place. Club lunch included.',
    matchDirector: 'Ron Millson Trophy Coordinator',
    rangesOpen: '8:00 AM Gates Open & Squad Sign-in',
    fees: '$35 entry fee (includes 100 targets & club lunch)',
    safetyBriefing: 'Open event safety briefing at 8:45 AM sharp.',
    visitorFriendly: true,
    trophies: 'Trophies to 5th place',
    lunchIncluded: true,
    program: [
      { name: 'S.C.M.L.C. 100 Bird - Ron Millson Trophy', targets: '100 Sporting Targets', type: 'Non Aggregate' },
    ],
  },
  {
  ...
  {
    id: 'evt-csr-2026-sep-12',
    day: '12',
    month: 'SEP',
    year: '2026',
    discipline: 'Civilian Service Rifle',
    title: 'Civilian Service Rifle Match',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'tan',
    description:
      'Inaugural monthly Civilian Service Rifle (CSR) match on the 2nd Saturday of each month. Historic military bolt-action service rifles (.303 Lee-Enfield, Mauser 98, Mosin-Nagant, Springfield 1903, K31). Positional courses of fire at 100m and 200m mounds.',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Range Safety Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Chamber safety flags mandatory. Muzzle awareness and bolt-open protocol strictly enforced.',
    visitorFriendly: true,
    program: [
      { name: 'Prone Application (100m / 200m)', targets: '10 Shots Deliberate', type: 'Precision' },
      { name: 'Rapid Fire with Reload', targets: '10 Shots in 60s', type: 'Timed' },
      { name: 'Positional Snap Shooting', targets: '5 Shots Positional', type: 'Snap' },
    ],
  },
  {
    id: 'evt-sep-02',
  ...
  {
    id: 'evt-shotgun-2026-sep-13',
    day: '13',
    month: 'SEP',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Flintlock Trap',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Official Shotgun program with 4 Aggregate events: Hero of the Hill (50 Sporting Targets), Modern 25 (Left to Right Crossers S/B), B P Cartridge (20 Sporting Targets), and Flintlock Shotgun (10 Trap).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Flint flash guards recommended. Card wads only.',
    visitorFriendly: true,
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: 'Left to Right Crossers S/B', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Sporting Targets', type: 'Aggregate' },
      { name: 'Flintlock Shotgun', targets: '10 Trap', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-sep-03',
  ...
  },
  {
    ...
    themeColor: 'tan',
    description:
      'Second Saturday monthly Civilian Service Rifle match. Historic military service rifles (.303 Lee-Enfield, Mauser 98, Mosin-Nagant, Springfield, K31). Positional courses of fire at 100m and 200m mounds.',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Chamber flags mandatory when rifles are off the firing line. Muzzle awareness enforced.',
    visitorFriendly: true,
    program: [
      { name: 'Prone Application (100m / 200m)', targets: '10 Shots Deliberate', type: 'Precision' },
      { name: 'Rapid Fire with Reload', targets: '10 Shots in 60s', type: 'Timed' },
  ...
  {
    id: 'evt-shotgun-2026-oct-11',
    day: '11',
    month: 'OCT',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Percussion Overhead',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Spring Shotgun program with 4 Aggregate matches: Hero of the Hill (50 Sporting Targets), Modern 25 (Trap S/B), B P Cartridge (20 Sporting Targets), and Percussion (10 Overhead).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Overhead target safety zones strictly observed.',
    visitorFriendly: true,
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: 'Trap S/B', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Sporting Targets', type: 'Aggregate' },
      { name: 'Percussion', targets: '10 Overhead', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-shotgun-2026-nov-08',
    day: '08',
    month: 'NOV',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Flintlock Surprise',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Official Shotgun program with 4 Aggregate stages: Hero of the Hill (50 Sporting Targets), Modern 25 (25 Sporting Targets S/B), B P Cartridge (20 Trap), and Flintlock Shotgun (10 Surprise Targets).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Surprise target trap release rules announced at 8:45 AM briefing.',
    visitorFriendly: true,
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 Sporting Targets S/B', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Trap', type: 'Aggregate' },
      { name: 'Flintlock Shotgun', targets: '10 Surprise Targets', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-csr-2026-nov-14',
    day: '14',
    month: 'NOV',
    year: '2026',
    discipline: 'Civilian Service Rifle',
  ...
  {
    id: 'evt-csr-2026-dec-12',
    day: '12',
    month: 'DEC',
    year: '2026',
    discipline: 'Civilian Service Rifle',
    title: 'Civilian Service Rifle Match & Year-End Shoot',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'tan',
    description:
      'Second Saturday monthly Civilian Service Rifle match and festive season longarm shoot. Positional course of fire at 100m and 200m mounds followed by end-of-year camaraderie.',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Chamber flags mandatory when rifles are off the firing line. Muzzle awareness enforced.',
  ...
  {
    id: 'evt-shotgun-2026-dec-13',
    day: '13',
    month: 'DEC',
    year: '2026',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Novelty Events for Prizes',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Year-End Shotgun Shoot & Festive Novelty Match: Hero of the Hill (50 Sporting Targets, Aggregate) plus Novelty Events for Prizes (Aggregate)! End-of-year awards and barbecue.',
    matchDirector: 'Shotgun Committee & Club Executive',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors (Prizes included)',
    safetyBriefing: 'Novelty match stage safety briefed per squad.',
    visitorFriendly: true,
    trophies: 'Prizes for novelty events',
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Novelty Events for Prizes', targets: 'Novelty Events', type: 'Aggregate' },
    ],
  },

  // 2027 Season
  {
    id: 'evt-csr-2027-jan-09',
    day: '09',
    month: 'JAN',
    year: '2027',
    discipline: 'Civilian Service Rifle',
    ...
    themeColor: 'tan',
    description:
      'Second Saturday monthly Civilian Service Rifle match. New Year service rifle shoot at 100m and 200m mounds. Historic bolt-action rifles (.303 Lee-Enfield, Mauser, Springfield, Mosin-Nagant).',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Summer hydration precautions in effect. Chamber safety flags mandatory.',
    visitorFriendly: true,
    program: [
      { name: 'Prone Application (100m / 200m)', targets: '10 Shots Deliberate', type: 'Precision' },
      { name: 'Rapid Fire with Reload', targets: '10 Shots in 60s', type: 'Timed' },
  ...
  {
    id: 'evt-shotgun-2027-jan-10',
    day: '10',
    month: 'JAN',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & New Year Aggregate',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Opening 2027 Shotgun Shoot with 4 Aggregate matches: Hero of the Hill (50 Sporting Targets), Modern 25 (25 Sporting Targets S/B), B P Cartridge (20 Sporting Targets), and Percussion Shotgun (10 Overhead).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Summer hydration and range fire precautions in effect.',
    visitorFriendly: true,
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 Sporting Targets S/B', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Sporting Targets', type: 'Aggregate' },
      { name: 'Percussion Shotgun', targets: '10 Overhead', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-csr-2027-feb-13',
    day: '13',
    month: 'FEB',
    year: '2027',
    discipline: 'Civilian Service Rifle',
    ...
    themeColor: 'tan',
    description:
      'Second Saturday monthly Civilian Service Rifle match. Positional course of fire at 100m and 200m mounds for historic military service rifles (.303 Lee-Enfield, Mauser 98, Mosin-Nagant, Springfield, K31).',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Chamber flags mandatory when rifles are off the firing line. Muzzle awareness enforced.',
  ...
  {
    id: 'evt-shotgun-2027-feb-14',
    day: '14',
    month: 'FEB',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Flintlock Overhead',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Official 2027 Shotgun program with 4 Aggregate stages: Hero of the Hill (50 Sporting Targets), Modern 25 (25 Sporting Targets S/B), B P Cartridge (20 Trap S/B), and Flintlock Shotgun (10 Overhead).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Flintlock pan priming protocols strictly at the firing pegs.',
    visitorFriendly: true,
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 Sporting Targets S/B', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Trap S/B', type: 'Aggregate' },
      { name: 'Flintlock Shotgun', targets: '10 Overhead', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-csr-2027-mar-13',
    day: '13',
    month: 'MAR',
    year: '2027',
    discipline: 'Civilian Service Rifle',
  ...
  {
    id: 'evt-shotgun-2027-mar-14',
    day: '14',
    month: 'MAR',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'Ken Turnbull & T&T Double Rise Trophies',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Annual Trophy Match Day: Hero of the Hill (50 Sporting Targets), Modern 25 (25 Overhead S/B), B.P Cartridge Ken Turnbull Trophy (20 Trap), and Percussion Shotgun T&T Double Rise Trophy (10 Doubles). All 4 Aggregate.',
    matchDirector: 'Shotgun Section Captain & Trophy Stewards',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Double rise safety commands and concurrent target etiquette briefed.',
    visitorFriendly: true,
    trophies: 'Ken Turnbull Trophy & T&T Double Rise Trophy',
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 Overhead S/B', type: 'Aggregate' },
      { name: 'B.P Cartridge - Ken Turnbull Trophy', targets: '20 Trap', type: 'Aggregate' },
      { name: 'Percussion Shotgun - T&T Double Rise Trophy', targets: '10 Doubles', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-shotgun-2027-mar-21',
    day: '21',
    month: 'MAR',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'S.C.M.L.C. 100 Bird - Open Shoot',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'S.C.M.L.C. 100 Bird Open Shoot across 100 Target (Aggregate). Open to all shotgun competitors. Trophies to 5th place. Lunch included.',
    matchDirector: '100-Bird Match Coordinator',
    rangesOpen: '8:00 AM Squad Registration & Warm-up',
    fees: '$35 entry fee (includes 100 targets & hot lunch)',
    safetyBriefing: 'Mandatory open shoot safety briefing at 8:45 AM.',
    visitorFriendly: true,
    trophies: 'Trophies to 5th place',
    lunchIncluded: true,
    program: [
      { name: 'S.C.M.L.C. 100 Bird - Open Shoot', targets: '100 Target', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-csr-2027-apr-10',
    day: '10',
    month: 'APR',
    year: '2027',
    discipline: 'Civilian Service Rifle',
    ...
    themeColor: 'tan',
    description:
      'Second Saturday monthly Civilian Service Rifle match. Autumn service rifle positional shooting at 100m and 200m mounds (.303 Lee-Enfield, Mauser, Springfield, Mosin-Nagant).',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Chamber flags mandatory when rifles are off the firing line. Muzzle awareness enforced.',
  ...
  {
    id: 'evt-shotgun-2027-apr-11',
    day: '11',
    month: 'APR',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Winchester Trophy',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Official Shotgun program with 4 Aggregate events: Hero of the Hill (50 Sporting Targets), Modern 25 (25 Sporting Targets S/B), B P Cartridge (20 Sporting Targets), and Flintlock Shotgun Winchester Trophy (10 Targets).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Winchester Trophy flintlock scrutineering at 8:30 AM.',
    visitorFriendly: true,
    trophies: 'Winchester Trophy for Flintlock Shotgun',
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 Sporting Targets S/B', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Sporting Targets', type: 'Aggregate' },
      { name: 'Flintlock Shotgun - Winchester Trophy', targets: '10 Targets', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-csr-2027-may-08',
    day: '08',
    month: 'MAY',
    year: '2027',
    discipline: 'Civilian Service Rifle',
  ...
  {
    id: 'evt-shotgun-2027-may-16',
    day: '16',
    month: 'MAY',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Olympia Trophy',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Official Shotgun program (Note: Mother’s Day is Sunday 09th May; shoot held on 3rd Sunday): Hero of the Hill (50 Sporting Targets), Modern 25 (25 Right to Left Crossers), B P Cartridge (20 Sporting Targets), and Percussion Shotgun Olympia Trophy (10 Trap / 10 Behind / 10 Overhead). All 4 Aggregate.',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Olympia 3-discipline layout briefing at 8:45 AM.',
    visitorFriendly: true,
    trophies: 'Olympia Trophy for Percussion Shotgun',
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 Right to Left Crossers', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Sporting Targets', type: 'Aggregate' },
      { name: 'Percussion Shotgun - Olympia Trophy', targets: '10 Trap / 10 Behind / 10 Overhead', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-csr-2027-jun-12',
    day: '12',
    month: 'JUN',
    year: '2027',
    discipline: 'Civilian Service Rifle',
    ...
    themeColor: 'tan',
    description:
      'Second Saturday monthly Civilian Service Rifle match. Winter service rifle positional competition at 100m and 200m mounds.',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Chamber flags mandatory when rifles are off the firing line. Muzzle awareness enforced.',
  ...
  {
    id: 'evt-shotgun-2027-jun-13',
    day: '13',
    month: 'JUN',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'Hero of the Hill & Flintlock Tower',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'Official Shotgun program with 4 Aggregate matches: Hero of the Hill (50 Sporting Targets), Modern 25 (25 Sporting Targets S/B), B P Cartridge (20 Overhead), and Flintlock Shotgun (10 Tower).',
    matchDirector: 'Shotgun Section Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'High tower target trajectory safety protocols enforced.',
    visitorFriendly: true,
    program: [
      { name: 'Hero of the Hill', targets: '50 Sporting Targets', type: 'Aggregate' },
      { name: 'Modern 25', targets: '25 Sporting Targets S/B', type: 'Aggregate' },
      { name: 'B P Cartridge', targets: '20 Overhead', type: 'Aggregate' },
      { name: 'Flintlock Shotgun', targets: '10 Tower', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-shotgun-2027-jun-20',
    day: '20',
    month: 'JUN',
    year: '2027',
    discipline: 'Shotgun events',
    title: 'The Black Magic 75 - BP Cartridge Open',
    location: 'Sackville Range',
    time: '9:00 AM',
    themeColor: 'rust',
    description:
      'The Black Magic 75 — Premier Open Event for Black Powder Cartridge Shotguns. 75 Sporting Targets (Aggregate). Trophies to 5th place. Club lunch included.',
    matchDirector: 'Black Magic 75 Match Marshal',
    rangesOpen: '8:00 AM Sign-in & Scrutineering',
    fees: '$30 entry fee (includes 75 targets & club lunch)',
    safetyBriefing: 'Black powder cartridge specifications and inspection at 8:30 AM.',
    visitorFriendly: true,
    trophies: 'Trophies to 5th place',
    lunchIncluded: true,
    program: [
      { name: 'The Black Magic 75', targets: '75 Sporting Targets', type: 'Aggregate' },
    ],
  },
  {
    id: 'evt-csr-2027-jul-10',
    day: '10',
    month: 'JUL',
    year: '2027',
    discipline: 'Civilian Service Rifle',
    ...
    themeColor: 'tan',
    description:
      'Second Saturday monthly Civilian Service Rifle match held the day before the 2027 AGM. 100m and 200m positional course of fire for classic bolt-action military rifles.',
    matchDirector: 'Service Rifle Captain',
    rangesOpen: '8:15 AM Gates open, 8:45 AM Briefing',
    fees: '$15 members / $25 visitors',
    safetyBriefing: 'Chamber flags mandatory when rifles are off the firing line. Muzzle awareness enforced.',
...
export const NOTICES: Notice[] = [
  {
    id: 'notice-csr-launch',
    date: '12th September 2026',
    title: 'Civilian Service Rifle: 2nd Saturday of Each Month',
    summary: 'Regular monthly matches commencing Saturday 12th September 2026. Historic service longarms at 100m & 200m.',
    category: 'Match',
    urgent: false,
    body: `We are pleased to announce that Civilian Service Rifle matches are scheduled for the 2nd Saturday of each month at the Sackville Range, commencing on Saturday 12th September 2026.

Eligible Firearms:
• Historic military bolt-action service rifles (Lee-Enfield .303, Mauser 98, Swedish Mauser, Mosin-Nagant, Springfield 1903, P14/M1917, K31, and Cadet rifles).
• Standard military service calibers conforming to Sackville Range template safety limits.

Course of Fire:
• 100m and 200m mounds.
• Deliberate Prone Application (10 shots), Rapid Fire with reload (10 shots in 60s), and Positional Snap Shooting (5 shots).

Gates open at 8:15 AM with mandatory range safety briefing at 8:45 AM. All members and licensed visitors welcome!`,
  },
  {
