    ...
    <section className="relative w-full min-h-[580px] sm:min-h-[640px] lg:min-h-[700px] flex items-center overflow-hidden bg-[#152E20]" id="hero-section">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 w-full">
        <div className="max-w-2xl sm:max-w-3xl">
          {/* Club Identity Badge */}
          <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-[#0E1F15]/85 border border-[#C5A880]/45 backdrop-blur-sm mb-6 shadow-sm">
            <span className="w-2 h-2 rounded-full bg-[#C5A880] shrink-0 shadow-xs" />
            <span className="text-[11px] sm:text-xs tracking-[0.2em] uppercase font-semibold text-[#E6DCBF]">
              Sydney Colonial Muzzle-Loading Club · Est. 1962
            </span>
          </div>
